...
void imu_update_data_task(void *arg)
{
    ...
    while (1)
    {
        msg_imu.angular_velocity.x = proto_imu_data.gyro[0];
        msg_imu.angular_velocity.y = proto_imu_data.gyro[1];
        msg_imu.angular_velocity.z = proto_imu_data.gyro[2];

        msg_imu.linear_acceleration.x = proto_imu_data.accel[0];
        msg_imu.linear_acceleration.y = proto_imu_data.accel[0];
        msg_imu.linear_acceleration.z = proto_imu_data.accel[0];
